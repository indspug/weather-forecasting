...
NUMBER_OF_INPUT_NODES = 5   	# 入力データ数:(水戸,前橋,東京)x(降水量,湿度,気圧,天気)
...
RESULT_FILE_WHOLE = './result/rnn_result_190812_06_whole.csv'
RESULT_FILE_NAME  = './result/rnn_result_190812_06'

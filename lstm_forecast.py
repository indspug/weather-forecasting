...
NUMBER_OF_INPUT_NODES = 12	# 入力データ数:(水戸,前橋,東京)x(降水量,湿度,気圧,天気)
...
RESULT_FILE_WHOLE = './result/rnn_result_190812_05_whole.csv'
RESULT_FILE_NAME  = './result/rnn_result_190812_05'
...
def output_whole_result_header():
	...
	fo.write('##################################################\n')
	fo.write('入力データ = (水戸,前橋,東京)x(降水量,湿度,気圧,天気)\n')
...
def output_result(input, target, predicted, number):
	...
	fo.write('降水量,湿度,気圧,天気,降水量,湿度,気圧,天気,降水量,湿度,気圧,天気,晴れ,曇り,雨,晴れ,曇り,雨,正解/不正解\n')

...
NUMBER_OF_INPUT_NODES = 4	# 入力データ数(水戸の天気,東京の天気,静岡の天気,大阪の天気)
...
def output_whole_result_header():
	...
	fo.write('##################################################\n')
	fo.write('入力データ = 水戸の天気,東京の天気,静岡の天気,大阪の天気\n')
...
def output_result(input, target, predicted, number):
	...
	fo = open(filename, 'w')
	fo.write('天気(水戸),天気(東京),静岡の天気,天気(大阪),晴れ,曇り,雨,晴れ(予測),曇り(予測),雨(予測),正解/不正解\n')

...
NUMBER_OF_HIDDEN_NODES_FOR_CLASS = 64	# 隠れ層のノード数
NUMBER_OF_OUTPUT_NODES_FOR_CLASS = 3	# 出力データ数(晴れ,曇り,雨)
DROPOUT_RATE_FOR_CLASS = 0.2		# ドロップアウト率
LEARNING_RATE_FOR_CLASS = 0.0001	# 学習率
SIZE_OF_BATCH_FOR_CLASS = 128		# バッチサイズ
RESULT_FILE_NAME_FOR_CLASS  = './result/result_190917_lstm_class_04'
...
RESULT_FILE_WHOLE = './result/result_190917_lstm_class_04.csv'

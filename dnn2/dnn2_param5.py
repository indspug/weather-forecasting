...
RESULT_FILE_WHOLE = './result4/result_190917_dnn2_05.csv'
SAVE_CYCLE = 1000		# 保存周期(N回学習につき1回保存)
MODEL_DIR  = 'ckpt'		# モデル保存先ディレクトリ
MODEL_NAME = 'model_190917_dnn2_05'	# 保存するモデルのファイル名
NUMBER_OF_POINTS = 2		# 入力データの地点数
...
def output_whole_result_header():
	...
	fo.write('##################################################\n')
	fo.write('入力データ = (水戸,前橋)x(気温,降水量,湿度,気圧)\n')

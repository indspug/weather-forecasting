...
# 分類用のパラメータ
##############################
NUMBER_OF_INPUT_NODES = 36	# 入力データ数:(水戸,前橋,東京,静岡,大阪,秩父,河口湖,新潟,宇都宮)x(気温,降水量,湿度,気圧)
...
RESULT_FILE_WHOLE = './result2/result_190917_dnn2_03.csv'
SAVE_CYCLE = 1000		# 保存周期(N回学習につき1回保存)
MODEL_DIR  = 'ckpt'		# モデル保存先ディレクトリ
MODEL_NAME = 'model_190917_dnn2_03'	# 保存するモデルのファイル名
NUMBER_OF_POINTS = 9		# 入力データの地点数
